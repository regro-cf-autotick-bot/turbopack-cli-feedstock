...
pixi add turbopack-cli
# for installing globally
pixi global install turbopack-cli
```
...
It is possible to list all of the versions of `turbopack-cli` available on your platform:
...
```
pixi search turbopack-cli --channel conda-forge
```
